defmodule CrudryContextTest do
  ...
  test "choose which CRUD functions are to be generated" do
    ...
    assert length(ContextOnly.__info__(:functions)) == 4
    ...
    assert length(ContextExcept.__info__(:functions)) == 10
  end
  ...
  test "choose which CRUD functions are to be generated by default" do
    ...
    assert length(ContextOnlyDefault.__info__(:functions)) == 4
    ...
    assert length(ContextExceptDefault.__info__(:functions)) == 10
  end
