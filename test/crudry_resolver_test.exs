defmodule CrudryResolverTest do
  ...
  test "choose which CRUD functions are to be generated" do
    ...
    assert length(ResolverOnly.__info__(:functions)) == 2
    ...
    assert length(ResolverExcept.__info__(:functions)) == 3
  end
  ...
  test "choose which CRUD functions are to be generated by default" do
    ...
    assert length(ResolverOnlyDefault.__info__(:functions)) == 2
    ...
    assert length(ResolverExceptDefault.__info__(:functions)) == 3
  end
end
